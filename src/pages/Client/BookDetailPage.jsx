                    ...
                    <div style={{ display: "flex", gap: 60 }}>
                        ...
                        <div className="col-md-3 text-center bg-[#f4f2ee]" tyle={{ padding: 20, maxWidth: 1200, margin: "0 auto" }}>
                            <Image style={{
                                ...
                                src={product.imagesProduct?.[selectedImage] || product.image} 
                        ...
                        <div className="md:col-span-7 p-10 lg:p-16 flex flex-col gap-6" style={{ flex: 1 }}>
                            ...
                            <div className="flex items-center gap-4 mt-2 " >
                                    ...
                                    <span className="text-lg text-black-300 line-through" style={{ fontSize: 24, color: "red", fontWeight: 700 }}>
                                        {product.price}
                                    </span>
                            ...
                            <div className="bg-gray-50/80 p-6 lg:p-8 rounded-3xl relative mt-2">
                                <span className="absolute -top-3 left-6 bg-white px-3 text-gray-300 font-serif text-lg italic uppercase tracking-tighter">Description</span>
                                <p className="text-gray-500 leading-relaxed text-sm lg:text-base italic mb-0">
                                    "{product.descriptionProduct || "In the elderly population, aging results in the degradation of nerve cells, arthritis, and neurodegenerative disorders like Parkinson’s disease. Hand arthritis impacts nearly 40% of seniors over 65 (Arthritis Foundation, 2023), while Parkinson’s disease affects over 10 million people worldwide (Parkinson’s Foundation, 2023), , . ..."}"
                                </p>
                            </div>
