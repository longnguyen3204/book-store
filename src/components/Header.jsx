...
import { 
    ...
    DownOutlined, FacebookFilled, YoutubeFilled 
...
const handleSearch = (e) => {
    ...
    const userMenuItems = [
        ...
        { key: '3', label: 'Đăng xuất', onClick: () => message.info('Đã đăng xuất') },
    ];
        ...
        <span>Cart: ($0)</span>
            ...
            <div className="bg-[#f3f2ec] py-2 border-b border-gray-200">
                <div className="container mx-auto px-4 flex flex-col items-center gap-5">
                    ...
                    <Link to="/">
                        <img src={logo} alt="Logo" className="h-16 w-auto object-contain hover:scale-105 transition-transform" />
                    </Link>
