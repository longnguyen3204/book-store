  ...
  return (
    <div className="bg-[#f4f2ee] min-h-screen pb-20 pt-40">
      ...
      <div className="container mx-auto px-4 pt-32">
        ...
        <div className="bg-white rounded-[40px] shadow-sm overflow-hidden mb-12 border border-white">
          <div style={{ display: "flex", gap: 60 }}>
            ...
            <div
              ...
              tyle={{ padding: 20, maxWidth: 1200, margin: "0 auto" }}
            >
              <Image
                style={{
                  width: "100%",
            ...
            >
              {/* 1. Tên Sách */}
              <h1 className="text-5xl lg:text-6xl font-medium text-gray-800 leading-tight mb-3">
                {product.title}
              </h1>
              ...
              >
                {/*nút mua ngay */}
                <button onClick={() => message.success("Mua ngay thành công")}>
                  Mua ngay
                </button>
                {/* Nút Thêm vào giỏ */}
                <button
                ...
                <button
                  className="flex-1  hover:bg-red-50 text-red-400 flex items-center justify-center transition-all text-xl lg:text-2xl rounded-2xl border border-gray-100 shadow-sm"
                  onClick={() =>
            ...
            <List
              dataSource={[
                ...
                },
                {
                  user: "Anh Tuấn",
                  content:
                    "Sách hay nhưng giao hàng hơi chậm một chút do đơn vị vận chuyển.",
                  rate: 4,
                },
                {
                  user: "Ngọc Ánh",
                  content:
                    "Kiến thức trong sách rất thực tế, trình bày dễ hiểu và lôi cuốn.",
                  rate: 5,
                },
              ]}
              renderItem={(item) => (
        ...
        {/* Sản phẩm liên quan */}
        <div className="mt-24">
          <h2 className="text-2xl font-serif mb-10 text-gray-800">
              ...
              >
                <div className="bg-[#f4f2ee] rounded-[30px] p-8 mb-5 shadow-sm group-hover:shadow-xl transition-all duration-500 flex justify-center border border-white">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="h-44 object-contain transform group-hover:scale-110 transition-transform duration-500"
                  />
